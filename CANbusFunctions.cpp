...
void CANbusFunctions::CANmaster()
  ...
  while(CANworkingIndex != CANbufferIndex)
  {
    ...
    if(incomingCANinstruction[CANworkingIndex] != 0)
    {
      ...
      case('V'):  // Version number
        Serial.print("ID: ");
        Serial.print(CANincomingAddr[CANworkingIndex]);
        Serial.print("- Version: ");
        Serial.print((char)CANinstruction[CANworkingIndex]);
        Serial.print((char)incomingValue[CANworkingIndex][0]);
        Serial.print((char)incomingValue[CANworkingIndex][1]);
        Serial.print((char)incomingValue[CANworkingIndex][2]);
        Serial.print((char)incomingValue[CANworkingIndex][3]);
    ...
    {
      // Must have sent just a 32bit position
